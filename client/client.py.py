...
from modules.texaspoker.AI.simon_ai import ai
# *************************************************************************************************
            ...
            if res.type == MessageType_GameDecision:
               ...
               # self.initialized = True
                ...
                for player in self.state.player:
                    bet = player.totalbet
                    wealth = player.totalbet + player.money
                    bet_ratio = bet / wealth
                    if player.username not in self.bet_log.keys():
                        self.bet_log[player.username] = []
                    self.bet_log[player.username].append(bet_ratio)
...
# ************************************ modify here to use your own username! ***********************
    ...
    username = 'xianfengdui1'# sys.argv[1]
    # username = "myusername"
    logger = file_logger('/Users/Simon-CWG/Documents/quantresearch/Texaspoker/modules/texaspoker/AI/test_log')
# ****************************************************************************************************
